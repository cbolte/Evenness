...
Runthrough Code:
```{r}
det <- read_csv("Z:/Shared/Projects/Evenness/CSVs/All Core Array Detections.csv")

df_all_years <- read_csv("Z:/Shared/Projects/Evenness/CSVs/water_year_data.csv", 
...
grid.arrange(aa, bb, cc, dd, ncol=1, nrow=4, left = 'Total Movement', bottom='Rank        Cumulative % of Movement Observations')
